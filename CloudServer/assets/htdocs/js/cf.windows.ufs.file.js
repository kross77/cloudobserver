...
$(document).ready(function() {
	...
	$('body').append("<div class=\"hidden-c\" style=\"display: none;\"><!-- --><div id=\"tabs-ufs\" class=\"ufs\"><form method=\"POST\" id=\"ufs_form_upload\" enctype=\"multipart/form-data\" action=\"/ufs.service\"><input type=\"hidden\" name=\"redirect_location\" value=\""+location.href+"\"><input type=\"hidden\" class=\"f_type\" name=\"type\" value=\"none\"><fieldset><legend>Name:</legend><input type=\"text\" class=\"required\" name=\"file_name\" /></fieldset><fieldset><legend>Sharing settings:</legend><p><input type=\"radio\" name=\"is_public\" value=\"true\">Public</p><p><input type=\"radio\" name=\"is_public\" value=\"false\" checked>Private</p></fieldset><fieldset><legend>File:</legend><input type=\"file\" class=\"f_f\" name=\"datafile\"></fieldset><input type=\"submit\" class=\"eButton\" value=\"Upload\" /><input type=\"button\" class=\"eButton\" value=\"Cancel\" onClick=$(\".alert\").hide() /></form></div><!-- --><div id=\"tabs-ufs-update\" class=\"ufs\"><form method=\"POST\" id=\"ufs_form_upload\" enctype=\"multipart/form-data\" action=\"/ufs.service\"><input type=\"hidden\" name=\"redirect_location\" value=\""+location.href+"\"><input type=\"hidden\" class=\"f_type\" name=\"type\" value=\"none\"><input type=\"hidden\" id=\"tabs-ufs-update-file_eu\" name=\"tabs-ufs-update-file_eu\" value=\"sha256.user.file\"><fieldset><legend>Name:</legend><input type=\"text\" class=\"required\" id=\"tabs-ufs-update-file_name\" name=\"file_name\"/></fieldset><fieldset><legend>Sharing settings:</legend><p><input type=\"radio\" name=\"is_public\" value=\"true\">Public</p><p><input type=\"radio\" name=\"is_public\" value=\"false\" checked>Private</p></fieldset><fieldset><legend>New File:</legend><input type=\"file\" class=\"f_f\" name=\"datafile\"></fieldset><input type=\"submit\" class=\"eButton\" value=\"Upload\" /><input type=\"button\" class=\"eButton\" value=\"Cancel\" onClick=\'$(\".alert\").hide();\' /></form></div><!-- --></div>");
