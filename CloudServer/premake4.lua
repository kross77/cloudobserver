...
------------------------------------------------------------------------------------------------
	inject ("lua/extra/project.boost-sqlite.lua")
------------------------------------------------------------------------------------------------
...
-- services ----------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------
	inject ("lua/services/project.UsersAccountsService.lua")
----------------------------------------------------------------------------------------------
	inject ("lua/services/project.ObserverService.lua")
----------------------------------------------------------------------------------------------			
	inject ("lua/services/project.FileService.lua")
------------------------------------------------------------------------------------------------		
	inject ("lua/services/project.UsersFilesService.lua")
------------------------------------------------------------------------------------------------
	inject ("lua/services/project.ImageRendererService.lua")
------------------------------------------------------------------------------------------------
	inject ("lua/services/project.RunService.lua")
------------------------------------------------------------------------------------------------