...
bool application_t::_initialize()
{
    ...
    //
    adobe::file_slurp<char>     glossary_slurp(adobe::find_resource(boost::filesystem::path("assets/CloudAdamAndEve_glossary.xstr", boost::filesystem::native)));
    adobe::xstring_context_t    context(glossary_slurp.begin(), glossary_slurp.end(),
                                        adobe::line_position_t( "assets/CloudAdamAndEve_glossary.xstr" ) );
    ...
    //
    bfs::path editor_adm(adobe::find_resource(boost::filesystem::path("assets/CloudAdamAndEve_editor.adm", boost::filesystem::native)));
    bfs::path editor_eve(adobe::find_resource(boost::filesystem::path("assets/CloudAdamAndEve_editor.eve", boost::filesystem::native)));
