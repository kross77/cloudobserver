...
ifeq ($(config),debug)
  OBJDIR     = bin/obj/Debug/lib-interoperability
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblib-interoperability.so
  DEFINES   += -DLIN -DDEBUG
...
ifeq ($(config),release)
  OBJDIR     = bin/obj/Release/lib-interoperability
...
ifeq ($(config),debug32)
  OBJDIR     = bin/obj/x32/Debug/lib-interoperability
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblib-interoperability.so
  DEFINES   += -DLIN -DDEBUG
  INCLUDES  += -I/opt/local/include -I/usr/include -I/usr/local/include -I../../libs
...
ifeq ($(config),release32)
  OBJDIR     = bin/obj/x32/Release/lib-interoperability
  TARGETDIR  = bin/release
  TARGET     = $(TARGETDIR)/liblib-interoperability.so
  DEFINES   += -DLIN -DNDEBUG
  INCLUDES  += -I/opt/local/include -I/usr/include -I/usr/local/include -I../../libs
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking lib-interoperability
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning lib-interoperability
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/cars.o: ../../src/lib-interoperability/cars.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
