...
ifeq ($(config),debug)
  OBJDIR     = bin/obj/Debug/lib-hello-world
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblib-hello-world.so
  DEFINES   += -DLIN -DDEBUG
...
ifeq ($(config),release)
  OBJDIR     = bin/obj/Release/lib-hello-world
...
ifeq ($(config),debug32)
  OBJDIR     = bin/obj/x32/Debug/lib-hello-world
  TARGETDIR  = bin/debug
  TARGET     = $(TARGETDIR)/liblib-hello-world.so
  DEFINES   += -DLIN -DDEBUG
  INCLUDES  += -I/opt/local/include -I/usr/include -I/usr/local/include -I../../libs
...
ifeq ($(config),release32)
  OBJDIR     = bin/obj/x32/Release/lib-hello-world
  TARGETDIR  = bin/release
  TARGET     = $(TARGETDIR)/liblib-hello-world.so
  DEFINES   += -DLIN -DNDEBUG
  INCLUDES  += -I/opt/local/include -I/usr/include -I/usr/local/include -I../../libs
...
$(OBJDIR)/c-style-functions.o: ../../src/lib-hello-world/c-style-functions.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
