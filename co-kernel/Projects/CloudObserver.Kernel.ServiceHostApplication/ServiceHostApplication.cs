...
namespace CloudObserver.Kernel.ServiceHostApplication
{
    /// <summary>
    ...
    public static class ServiceHostApplication
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                serviceContract = GetServiceContract(serviceType);
                serviceInstance = CreateServiceInstance(serviceType, serviceUri.Host);
            }
        ...
        public static object CreateServiceInstance(string serviceType, string ipAddress)
        {
            switch (serviceType)
            {
                case "CC":
                    return new CloudController(ipAddress);
                case "WB":
                    return new WorkBlock(ipAddress);
                default:
                    throw new ArgumentException("Invalid service type.");
            }
        }
