...
internal class _Super_BroadcastService extends WebServiceWrapper
{
    ...
    public function _Super_BroadcastService()
    {
        // initialize service control
         ...
         _serviceControl.service = "BroadcastService";
         _serviceControl.port = "BasicHttpBinding_BroadcastServiceContract";
    //     _serviceControl.wsdl = "http://93.100.45.201:9000/BroadcastService?wsdl";
