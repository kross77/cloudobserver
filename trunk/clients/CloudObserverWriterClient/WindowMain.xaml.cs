    ...
    public partial class WindowMain : Window
    {
        ...
        private void buttonCapture_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                capturer = new DsCapturer(videoInputDevices[comboBoxVideoSources.SelectedIndex], audioInputDevices[comboBoxAudioSources.SelectedIndex], textBoxTargetFile.Text);
