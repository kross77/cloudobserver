...
namespace CloudObserverDatabaseLibrary
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="CloudObserverDatabase")]
	public partial class CloudObserverDBDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteGroupCamera(GroupCamera instance);
		...
		public CloudObserverDBDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudObserverDBDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudObserverDBDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudObserverDBDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMarkerChanged();
		...
		[Column(Storage="_FrameID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int FrameID
		{
			get
			{
		...
		[Association(Name="Camera_Frame", Storage="_Camera", ThisKey="CameraID", OtherKey="CameraID", IsForeignKey=true)]
    ...
    partial void OnRegistrationDateChanged();
		...
		[Association(Name="Camera_Frame", Storage="_Frames", ThisKey="CameraID", OtherKey="CameraID")]
