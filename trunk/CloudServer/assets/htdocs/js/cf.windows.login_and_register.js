...
$(document).ready(function() {
	...
	login_html = "<div id=\"tabs-login\" class=\"login\"><form id=\"login\"  action=\"./uac.service\" ><input type=\"hidden\" name=\"redirect_to\" value=\""+location.href+"\"><input type=\"hidden\" name=\"user_control\" value=\"login\"><fieldset><legend>Email:</legend><input type=\"text\" class=\"required email\" name=\"login\" /></fieldset><fieldset><legend>Password:</legend><input type=\"hidden\" name=\"pass\" class=\"hidden_pass_value\" value=\"\"/><input type=\"password\" class=\"required pass_value\" /></fieldset><input type=\"submit\" class=\"eButton\" value=\"Submit\" /><input type=\"button\" class=\"eButton\" value=\"Cancel\" onClick=\'hideDialog($(\""+ class_login_alert + "\"))\' /></form></div><!-- -->";
